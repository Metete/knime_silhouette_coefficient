 ...
 * @author KNIME.com
 */
public class SilhouetteNodeNodePlugin extends Plugin {
    // The shared instance.
    private static SilhouetteNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public SilhouetteNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SilhouetteNodeNodePlugin getDefault() {
        return plugin;
    }
